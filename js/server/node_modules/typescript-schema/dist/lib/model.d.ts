...
export declare type RawType = Reference | RefinedReference | RawUnionType | RawFunctionType | RawTupleType | RawPrimitiveType | RawTypeQuery | RawCompositeType | RawTypeAlias;
...
export declare type RawExpression = RawComplexExpression | RawClassExpression | RawClassExpression | RawLiteralExpression<any> | RawArrayExpression | RawObjectExpression | RawEnumExpression;
...
export declare enum ModelKind {
    TYPE_CONTAINER = 1,
    CLASS_CONSTRUCTOR = 2,
    INTERFACE_CONSTRUCTOR = 3,
    TYPE = 4,
    INDEX = 5,
    TYPE_PARAMETER = 6,
    PARAMETER = 7,
    DECORATED_PARAMETER = 8,
    MEMBER = 9,
    DECORATED_MEMBER = 10,
    DECORATOR = 11,
    EXPRESSION = 12,
...
export declare enum TypeContainerKind {
    MODULE = 1,
    NAMESPACE = 2,
}
export declare type Type = Class | Interface | UnionType | FunctionType | TupleType | EnumType | PrimitiveType | TypeQuery | TypeAlias<any> | DecoratorType;
export declare type OpenType = Type | TypeParameter<any>;
...
export declare type ClassConstructorMember = DecoratedMember<DecoratedCompositeType<ClassConstructor>>;
export declare type ClassMember = DecoratedMember<DecoratedCompositeType<Class>>;
export declare type InterfaceConstructorMember = Member<ContainedCompositeType<InterfaceConstructor>>;
export declare type InterfaceMember = Member<ContainedCompositeType<Interface>>;
...
export declare type Expression = ComplexExpression | ClassExpression | LiteralExpression<any> | ArrayExpression | ObjectExpression | EnumExpression;
...
export declare enum DecoratorTypeKind {
    CLASS = 1,
    PROPERTY = 2,
    METHOD = 3,
    PARAMETER = 4,
...
export declare const BOOLEAN: PrimitiveType;
export declare const NUMBER: PrimitiveType;
export declare const ANY: PrimitiveType;
export declare const VOID: PrimitiveType;
