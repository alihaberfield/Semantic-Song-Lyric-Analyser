...
export declare function deployAssets(adminClient: Client, createClient: (database: string) => Client, deployer: AssetDeployer, model: m.Model, assetModel: m.AssetModel): Promise<boolean>;
